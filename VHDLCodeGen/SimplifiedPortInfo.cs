...
namespace VHDLCodeGen
{
	...
	public class SimplifiedPortInfo
	{
		...
		/// <exception cref="ArgumentException"><paramref name="name"/> is an empty string or <paramref name="bitWidth"/> is less than 1.</exception>
		public SimplifiedPortInfo(string name, PortDirection direction, int bitWidth)
		{
			if (name == null)
			...
			if (bitWidth < 1)
				throw new ArgumentException("bitWidth is less than one");
